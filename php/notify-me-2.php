<?php
	...
	$email_to = "matt@thebloxoffice.com"; // Write your email here to receive the email addresses submitted
    $subject = 'New subscriber from The Blox Office Splash Page'; // Write the subject you'll see in your inbox
									...
									<table cellpadding='0' cellspacing='0' border='0' align='center'  style='width: 100%;max-width:600px;background:#FFFFFF;margin:0 auto;border-radius:5px;padding:50px 30px'>
										...
										<tr>
											...
											<td width='400' align='center' style='padding-bottom:5px;'>
												<div>
													<p >One of your visitors has just subscribed to your mailing list, here is their email address :</p>
												</div>
											</td>
											<td width='100'>&nbsp;</td>
										</tr>
										<tr>
											...
											<td align='center' style='padding-top:25px;'>
												<table cellpadding='0' cellspacing='0' border='0' align='center' width='200' height='50'>
													<tr>
														<td bgcolor='#808080' align='center' style='border-radius:4px;padding:0 25px;color:#FFFFFF' height='50' width='auto'>
															<div>
																$email
															</div>
